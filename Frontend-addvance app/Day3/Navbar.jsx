  ...
  return (
    <nav className={`nav ${active ? "nav__active" : ""}`}>
      ...
      <ul className={`nav__menu ${active ? "show" : ""}`}>
        ...
        <li className="nav__item">
         <Link to="/Addevents"> <a href="#" className="nav__link">
           Add Events
          </a>
          </Link>
        </li>
        <li className="nav__item">
         <Link to="/AllEvents"> <a href="#" className="nav__link">
           All Events
          </a>
          </Link>
        </li>
        <li className="nav__item">
        <Link to="/AllBooking"> <a href="#" className="nav__link">
           AllBooking
          </a></Link>
        </li>
        <li className="log">
         <Link to='/LoginPage'> <a href="#" className="nav__link">
